...
public class TyCParser extends Parser {
	...
	public static final int
		...
		RULE_switch_stat = 19, RULE_break_stat = 20, RULE_continue_stat = 21, 
		RULE_return_stat = 22, RULE_expr_stat = 23, RULE_expr = 24, RULE_assign_expr = 25, 
		RULE_bin_expr = 26, RULE_bin_term = 27, RULE_un_expr = 28, RULE_un_term = 29, 
		RULE_pre_expr = 30, RULE_pre_term = 31, RULE_post_expr = 32, RULE_post_term = 33, 
		RULE_func_expr = 34, RULE_func_term = 35, RULE_mem_acc_expr = 36, RULE_mem_acc_term = 37, 
		RULE_inc_expr = 38, RULE_dec_expr = 39, RULE_case_expr_list = 40, RULE_case_expr = 41, 
		RULE_default_case_expr = 42, RULE_arg_list = 43, RULE_args = 44, RULE_arg = 45, 
		RULE_bin_op = 46, RULE_un_op = 47, RULE_pre_op = 48, RULE_post_op = 49;
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"if_stat", "while_stat", "for_stat", "switch_stat", "break_stat", "continue_stat", 
	...
	public final Break_statContext break_stat() throws RecognitionException {
		...
		enterRule(_localctx, 40, RULE_break_stat);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(250);
	...
	public final Continue_statContext continue_stat() throws RecognitionException {
		...
		enterRule(_localctx, 42, RULE_continue_stat);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(253);
	...
	public final Expr_statContext expr_stat() throws RecognitionException {
		...
		enterRule(_localctx, 46, RULE_expr_stat);
		try {
			setState(267);
			_errHandler.sync(this);
	...
	public final Bin_exprContext bin_expr() throws RecognitionException {
		...
		enterRule(_localctx, 52, RULE_bin_expr);
		try {
			setState(287);
			_errHandler.sync(this);
	...
	public final Bin_termContext bin_term() throws RecognitionException {
		...
		enterRule(_localctx, 54, RULE_bin_term);
		try {
			setState(300);
			_errHandler.sync(this);
	...
	public final Un_exprContext un_expr() throws RecognitionException {
		...
		enterRule(_localctx, 56, RULE_un_expr);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(302);
	...
	public final Un_termContext un_term() throws RecognitionException {
		...
		enterRule(_localctx, 58, RULE_un_term);
		try {
			enterOuterAlt(_localctx, 1);
			{
			}
	...
	public final Pre_exprContext pre_expr() throws RecognitionException {
		...
		enterRule(_localctx, 60, RULE_pre_expr);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(307);
	...
	public final Pre_termContext pre_term() throws RecognitionException {
		...
		enterRule(_localctx, 62, RULE_pre_term);
		try {
			enterOuterAlt(_localctx, 1);
			{
			}
	...
	public final Post_exprContext post_expr() throws RecognitionException {
		...
		enterRule(_localctx, 64, RULE_post_expr);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(312);
	...
	public final Post_termContext post_term() throws RecognitionException {
		...
		enterRule(_localctx, 66, RULE_post_term);
		try {
			enterOuterAlt(_localctx, 1);
			{
			}
	...
	public final Func_termContext func_term() throws RecognitionException {
		...
		enterRule(_localctx, 70, RULE_func_term);
		try {
			enterOuterAlt(_localctx, 1);
			{
			}
	...
	public final Mem_acc_exprContext mem_acc_expr() throws RecognitionException {
		...
		enterRule(_localctx, 72, RULE_mem_acc_expr);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(324);
	...
	public final Mem_acc_termContext mem_acc_term() throws RecognitionException {
		...
		enterRule(_localctx, 74, RULE_mem_acc_term);
		try {
			enterOuterAlt(_localctx, 1);
			{
			}
	...
	public final Inc_exprContext inc_expr() throws RecognitionException {
		...
		enterRule(_localctx, 76, RULE_inc_expr);
		try {
			setState(334);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
	...
	public final Dec_exprContext dec_expr() throws RecognitionException {
		...
		enterRule(_localctx, 78, RULE_dec_expr);
		try {
			setState(340);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
	...
	public final Case_expr_listContext case_expr_list() throws RecognitionException {
		...
		enterRule(_localctx, 80, RULE_case_expr_list);
		try {
			setState(346);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
	...
	public final Default_case_exprContext default_case_expr() throws RecognitionException {
		...
		enterRule(_localctx, 84, RULE_default_case_expr);
		try {
			setState(357);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
